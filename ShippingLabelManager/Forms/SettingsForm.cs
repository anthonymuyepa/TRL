...
public class SettingsForm : Form
{
    ...
    private void OnResetSite(object? s, EventArgs e)
    {
        ...
        ShippingLabelManager.Program.DB.ResetSiteSequence(site.Id, confirm.StartAt, confirm.ClearHistory);
    ...
    private void OnResetAll(object? s, EventArgs e)
    {
        ...
        if (confirm.ShowDialog(this) != DialogResult.OK) return;
        ShippingLabelManager.Program.DB.ResetAllSequences(confirm.StartAt, confirm.ClearHistory);
        var nl = Environment.NewLine;
        MessageBox.Show(
